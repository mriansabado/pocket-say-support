  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden" style={{background: 'linear-gradient(to bottom right, #ef4444, #f97316, #fbbf24, #3b82f6)'}}>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 sm:pt-24 md:pt-28 text-center animate-fade-in">
        ...
        {/* App Store Badge - Highlighted */}
        <div className="animate-slide-up mb-8">
          <a 
            href="https://apps.apple.com/app/pocketsay/id6756633082" 
            target="_blank" 
            rel="noopener noreferrer"
            className="inline-block transition-all duration-300 hover:scale-110 hover:shadow-2xl"
            aria-label="Download PocketSay on the App Store"
          >
            <div className="bg-white/95 backdrop-blur-lg rounded-2xl px-8 sm:px-12 py-5 sm:py-6 border-4 border-white shadow-2xl hover:shadow-white/50 transition-all">
              <div className="flex items-center gap-4 sm:gap-5">
                <svg className="w-12 h-12 sm:w-14 sm:h-14 text-gray-900" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.81-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M13 3.5c.73-.83 1.94-1.46 2.94-1.5.13 1.17-.34 2.35-1.04 3.19-.69.85-1.83 1.51-2.95 1.42-.15-1.15.41-2.35 1.05-3.11z"/>
                </svg>
                <div className="text-left">
                  <div className="text-xs sm:text-sm text-gray-600 uppercase tracking-wider font-medium mb-0.5">Download on the</div>
                  <div className="text-2xl sm:text-3xl font-bold text-gray-900">App Store</div>
                </div>
              </div>
            </div>
          </a>
